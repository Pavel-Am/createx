(() => {
    ...
    function initSliders() {
        if (document.querySelector(".testimonials-slider__slider")) new core(".team-slider__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
            ...
            speed: 800,
            navigation: {
                prevEl: ".team-slider__arrow.swiper-button-prev",
                nextEl: ".team-slider__arrow.swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".testimonials-slider__slider")) new core(".testimonials-slider__slider", {
            ...
            speed: 800,
            pagination: {
                el: ".slide-testimonials-slider__dotts.swiper-pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".slide-testimonials-slider__arrow.swiper-button-prev",
                nextEl: ".slide-testimonials-slider__arrow.swiper-button-next"
            },
            on: {}
        });
    }
